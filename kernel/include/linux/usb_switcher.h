...
extern unsigned long usb_switch_get_current_connection(void);
extern unsigned long usb_switch_get_previous_connection(void);
extern void usb_switch_unregister_notify(struct notifier_block *nb);
extern void usb_switch_register_notify(struct notifier_block *nb);
extern void usb_switch_enable(void);
extern void usb_switch_disable(void);
