...
static struct ab8500_i2c_ranges register_ranges[AB8500_NUM_BANKS] = {
	[0x0] = {
		.num_ranges = 0,
		.range = NULL,
	},
...
struct ab8500_i2c_ranges  *ab8500_register_debug( u32 *size )
{
	*size = ARRAY_SIZE(register_ranges);
