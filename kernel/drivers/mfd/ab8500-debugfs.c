				...
				struct seq_file *s)
{
	...
	if (debug_bank >= size) {
		dev_err(dev, "debugfs error debug_bank > size of array\n");
		return -EINVAL;
	}
...
static int __devinit ab8500_debug_probe(struct platform_device *plf)
{
	...
	file = debugfs_create_file("bat_ctrl",
				   (S_IRUGO | (S_IWUSR | S_IWGRP)),
				   ab8500_gpadc_dir,
				   &plf->dev,
	...
	file = debugfs_create_file("adc_aux1",
				   (S_IRUGO | (S_IWUSR | S_IWGRP)),
				   ab8500_gpadc_dir,
				   &plf->dev,
	...
	file = debugfs_create_file("adc_aux2",
				   (S_IRUGO | (S_IWUSR | S_IWGRP)),
				   ab8500_gpadc_dir,
				   &plf->dev,
	...
	file = debugfs_create_file("main_bat_v",
				   (S_IRUGO | (S_IWUSR | S_IWGRP)),
				   ab8500_gpadc_dir,
				   &plf->dev,
	...
	file = debugfs_create_file("vbus_v",
				   (S_IRUGO | (S_IWUSR | S_IWGRP)),
				   ab8500_gpadc_dir,
				   &plf->dev,
	...
	file = debugfs_create_file("bk_bat_v",
				   (S_IRUGO | (S_IWUSR | S_IWGRP)),
				   ab8500_gpadc_dir,
				   &plf->dev,
	...
	file = debugfs_create_file("die_temp",
				   (S_IRUGO | (S_IWUSR | S_IWGRP)),
				   ab8500_gpadc_dir,
				   &plf->dev,
