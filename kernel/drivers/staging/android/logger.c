...
static struct struct_marks_ver_mark marks_ver_mark = {
	...
	.second_start_addr=0x00000000 // it has dependency on h/w 
};
//}} Mark for GetLog -1/2
...
#ifndef CONFIG_SAMSUNG_USE_GETLOG
...
*/
	plat_log_mark.p_main = (void *)((unsigned int)_buf_log_main & address_mask);
	plat_log_mark.p_radio = (void *)((unsigned int)_buf_log_radio & address_mask);
	plat_log_mark.p_events = (void *)((unsigned int)_buf_log_events & address_mask);
	plat_log_mark.p_system = (void *)((unsigned int)_buf_log_system & address_mask);
