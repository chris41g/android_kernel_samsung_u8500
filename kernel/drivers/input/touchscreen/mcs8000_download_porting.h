...
#define MCSDL_RESETB_SET_HIGH()             		melfas_ts_cfg_pin(TSP_PIN_INTRPT, 1, 1)
#define MCSDL_RESETB_SET_LOW()              		melfas_ts_cfg_pin(TSP_PIN_INTRPT, 1, 0)
#define MCSDL_RESETB_SET_OUTPUT()           		melfas_ts_cfg_pin(TSP_PIN_INTRPT, 1, 0)
#define MCSDL_RESETB_SET_INPUT()            		melfas_ts_cfg_pin(TSP_PIN_INTRPT, 0, 0)
#else
...
#define MCSDL_GPIO_SCL_SET_HIGH()					melfas_ts_cfg_pin(TSP_PIN_SCL, 1, 1)
#define MCSDL_GPIO_SCL_SET_LOW()					melfas_ts_cfg_pin(TSP_PIN_SCL, 1, 0)

#define MCSDL_GPIO_SDA_SET_HIGH()					melfas_ts_cfg_pin(TSP_PIN_SDA, 1, 1)
#define MCSDL_GPIO_SDA_SET_LOW()					melfas_ts_cfg_pin(TSP_PIN_SDA, 1, 0)

#define MCSDL_GPIO_SCL_SET_OUTPUT()					melfas_ts_cfg_pin(TSP_PIN_SCL, 1, 0)
#define MCSDL_GPIO_SCL_SET_INPUT()					melfas_ts_cfg_pin(TSP_PIN_SCL, 0, 0)

#define MCSDL_GPIO_SDA_SET_OUTPUT()					melfas_ts_cfg_pin(TSP_PIN_SDA, 1, 0)
#define MCSDL_GPIO_SDA_SET_INPUT()					melfas_ts_cfg_pin(TSP_PIN_SDA, 0, 0)

#define MCSDL_GPIO_SDA_IS_HIGH()					((melfas_ts_check_input(TSP_PIN_SDA)> 0) ? 1 : 0)
