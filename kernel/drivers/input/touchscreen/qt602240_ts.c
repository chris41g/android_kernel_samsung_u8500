...
#define QT602240_MAX_XC			470
//#define QT602240_MAX_YC			0x3ff
#define QT602240_MAX_YC			790
		...
		const struct i2c_device_id *id)
{
	...
	input_set_abs_params(input_dev, ABS_X,
			     10, QT602240_MAX_XC, 0, 0);
	input_set_abs_params(input_dev, ABS_Y,
			     10, QT602240_MAX_YC, 0, 0);
...
#define QT602240_PM_OPS		(&qt602240_pm_ops)
#else
#define QT602240_PM_OPS		NULL
#endif
