...
extern u16 mxt_get_object_address(uint8_t object_type, uint8_t instance, struct mxt_object *object_table, int max_objs);
extern u16 mxt_get_object_size(uint8_t object_type, struct mxt_object *object_table, int max_objs);
extern int backup_to_nv(struct mxt_data *mxt);
extern int mxt_reset_chip(struct mxt_data *mxt, u8 mode);
