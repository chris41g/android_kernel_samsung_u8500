...
/* gpio definitions we have two connections as well as USB */
...
static void TI_SWreset(struct FSA9480_instance *instance)
{
	...
	gpio_request(MUS_SCL_R0_0, "MUSB_SWITCH_SCL");
	gpio_request(MUS_SDA_R0_0, "MUSB_SWITCH_SDA");
	...
	write_FSA9480_register(instance, FSA9490_INTERRUPT_MASK_1_REGISTER, 0xfc);
	write_FSA9480_register(instance, FSA9490_INTERRUPT_MASK_2_REGISTER, 0x1f);
	...
	printk(KERN_INFO "[FSA9480] TI_SWreset ...Done\n");
}
	...
	const struct i2c_device_id *id)
{
	...
	i2c_set_clientdata(client, &driver_instance);
