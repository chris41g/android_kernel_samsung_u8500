 ...
 * @is_cs_deselected: denotes chip select is deselected or still being held
 *	because the last transfer was for the same spi device.
 */
struct pl022 {
