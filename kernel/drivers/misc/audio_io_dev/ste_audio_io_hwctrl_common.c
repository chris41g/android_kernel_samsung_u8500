...
struct gain_descriptor_t gain_descriptor[MAX_NO_TRANSDUCERS]\
	...
	EDestinationEar */
    /* note:
    	To force gain value the min and max value must be to set to same value 
        as exemple set G3 gain to -5 dB : {-5, -5, 1}*/
    /* G3 gain           G4 gain                                       */
    {{{0, 0, 1},	{3, 3, 1},	{0, 0, 0} } ,/* channelIndex=0: earpiece */
    {{0, 0, 0},		{0, 0, 0},	{0, 0, 0} } ,/* channelIndex=1: not used */
    {{0, 0, 0},		{0, 0, 0},	{0, 0, 0} } ,/* channelIndex=2: not used */
    {{0, 0, 0},		{0, 0, 0},	{0, 0, 0} } } ,/* channelIndex=3: not used */

    /* EDestinationHS */
    /* G3 gain           G4 gain         analog gain                        */
    {{{0, 0, 1},	{0, 0, 1},	{0, 0, 2} } , /* channelIndex=0 : Headset Left */
    {{0, 0, 1},	        {0, 0, 1},	{0, 0, 2} } , /* channelIndex=1 : Headset right*/
    {{0, 0, 0},		{0, 0, 0},	{0, 0, 0} } ,	  /* channelIndex=2: not used */
    {{0, 0, 0},		{0, 0, 0},	{0, 0, 0} } } ,	  /* channelIndex=3 : not used*/

    /* EDestinationIHF */
    /* G3 gain                                                         */
    {{{0, 0, 1},	{0, 0, 0},	{0, 0, 0} } ,/* channelIndex=0: not used */
    {{0, 0, 1},	        {0, 0, 0},	{0, 0, 0} } ,/* channelIndex=1: Speaker */
    {{0, 0, 0},		{0, 0, 0},	{0, 0, 0} } ,/* channelIndex=2: not used */
    {{0, 0, 0},		{0, 0, 0},	{0, 0, 0} } } ,/* channelIndex=3: not used */
    ...
    /* ESourceMic1B */
    {{{17, 17, 1}, {15, 15, 1},	{0, 0, 0} } ,/* channelIndex=0: built-in mic */
    {{0, 0, 0},		{0, 0, 0},	{0, 0, 0} } ,/* channelIndex=1: not used */
    {{0, 0, 0},		{0, 0, 0},	{0, 0, 0} } ,/* channelIndex=2: not used */
    {{0, 0, 0},		{0, 0, 0},	{0, 0, 0} } } ,/* channelIndex=3: not used */

    /* ESourceMic2 */
    {{{17, 17, 1}, {15, 15, 1},	{0, 0, 0} } ,/* channelIndex=0: headset mic */
    {{0, 0, 0},		{0, 0, 0},	{0, 0, 0} } ,/* channelIndex=1: not used */
    {{0, 0, 0},		{0, 0, 0},	{0, 0, 0} } ,/* channelIndex=2: not used */
    {{0, 0, 0},		{0, 0, 0},	{0, 0, 0} } } ,/* channelIndex=3: not used */
