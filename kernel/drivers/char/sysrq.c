...
static void sysrq_handle_dsp_crash(int key, struct tty_struct *tty)
{
#if 0
	dump_all_task_info();
	dump_cpu_stat();
#endif
	panic("__MMDSP_forced_upload");
}
static struct sysrq_key_op sysrq_dsp_crash_op = {
	.handler	= sysrq_handle_dsp_crash,
	.help_msg	= "DSP Crash(M)",
