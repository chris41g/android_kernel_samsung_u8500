...
#if defined (CONFIG_MACH_SAMSUNG_P3) || defined (CONFIG_MACH_SAMSUNG_T1) || defined (CONFIG_MACH_SAMSUNG_Q1)
#include <mach/gpio.h>
...
extern int u8500_wifi_power(int on, int flag);
#endif
