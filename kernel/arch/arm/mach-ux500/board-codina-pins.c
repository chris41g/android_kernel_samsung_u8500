...
static pin_cfg_t codina_r0_0_pins[] = {
	...
	GPIO10_GPIO		| PIN_INPUT_NOPULL,
	GPIO11_GPIO		| PIN_INPUT_NOPULL,
	...
	GPIO86_GPIO		| PIN_INPUT_PULLDOWN,	/* GPS_ON_OFF (R2) */
...
static UX500_PINS(codina_r0_0_pins_uart0,
...
static struct ux500_pin_lookup codina_r0_0_lookup_pins[] = {
	PIN_LOOKUP("uart0", &codina_r0_0_pins_uart0),
...
static pin_cfg_t codina_gps_rev0_0_pins[] = {
	GPIO4_U1_RXD | PIN_INPUT_PULLUP, /* GPS UART */
	GPIO5_U1_TXD | PIN_OUTPUT_HIGH, /* GPS UART */
	GPIO6_U1_CTSn | PIN_OUTPUT_HIGH,
	/* GPIO7_U1_RTSn | PIN_INPUT_PULLDOWN, */
	GPIO7_GPIO | PIN_OUTPUT_LOW,

	PIN_CFG(GPS_RST_N_CODINA_R0_0, GPIO) | PIN_OUTPUT_HIGH,
	PIN_CFG(GPS_ON_OFF_CODINA_R0_0, GPIO) | PIN_OUTPUT_LOW,
};

static pin_cfg_t codina_gps_rev0_2_pins[] = {
	GPIO4_U1_RXD | PIN_INPUT_PULLUP, /* GPS UART */
	GPIO5_U1_TXD | PIN_OUTPUT_HIGH, /* GPS UART */
	...
	PIN_CFG(GPS_RST_N_CODINA_R0_0, GPIO) | PIN_OUTPUT_HIGH,
	PIN_CFG(GPS_ON_OFF_CODINA_R0_2, GPIO) | PIN_OUTPUT_LOW,
};
...
static void __init gps_pins_init(void)
{
	...
	pin_cfg_t GPS_ON_OFF_CODINA;
	if (system_rev == CODINA_R0_0 || system_rev == CODINA_R0_1) {
		nmk_config_pins(codina_gps_rev0_0_pins,
		ARRAY_SIZE(codina_gps_rev0_0_pins));
		GPS_ON_OFF_CODINA = GPS_ON_OFF_CODINA_R0_0;
	} else if (system_rev >= CODINA_R0_2) {
		nmk_config_pins(codina_gps_rev0_2_pins,
		ARRAY_SIZE(codina_gps_rev0_2_pins));
		GPS_ON_OFF_CODINA = GPS_ON_OFF_CODINA_R0_2;
	}

	gpio_request(GPS_RST_N_CODINA_R0_0, "GPS_nRST");
	gpio_direction_output(GPS_RST_N_CODINA_R0_0, 1);
	gpio_request(GPS_ON_OFF_CODINA, "GPS_ON_OFF");
	gpio_direction_output(GPS_ON_OFF_CODINA, 0);

	gpio_export(GPS_RST_N_CODINA_R0_0, 1);
	gpio_export(GPS_ON_OFF_CODINA, 1);

	BUG_ON(!gps_dev);
	gpio_export_link(gps_dev, "GPS_nRST", GPS_RST_N_CODINA_R0_0);
	gpio_export_link(gps_dev, "GPS_ON_OFF", GPS_ON_OFF_CODINA);
}
...
static void __init sdmmc_pins_init(void)
{
	...
	if (sec_debug_settings & SEC_DBG_STM_APE_OPT) {
		...
		codina_regulators[AB8500_LDO_AUX3].constraints.valid_ops_mask = 0;
		codina_regulators[AB8500_LDO_AUX3].constraints.always_on = 1;
...
static pin_cfg_t codina_r0_0_power_save_bank0[] = {
	...
	GPIO17_GPIO | PIN_SLPM_DIR_INPUT |
		PIN_SLPM_WAKEUP_ENABLE | PIN_SLPM_PDIS_DISABLED,
	GPIO18_GPIO | PIN_SLPM_DIR_INPUT |
		PIN_SLPM_WAKEUP_ENABLE | PIN_SLPM_PULL_DOWN, /* NC */
	GPIO19_GPIO | PIN_SLPM_DIR_INPUT |
		PIN_SLPM_WAKEUP_ENABLE | PIN_SLPM_PULL_DOWN, /* NC */

	GPIO20_GPIO | PIN_SLPM_DIR_INPUT |
		PIN_SLPM_WAKEUP_ENABLE | PIN_SLPM_PULL_DOWN, /* NC */
	/* GPIO21_GPIO (GPS_RST_N) no change */
	/* SD/MMC card pins handled in seperate table (GPIOs 22-28, excl 21) */
...
static void codina_pins_suspend_force(void)
{
	if (system_rev >= CODINA_R0_0) {
		sleep_pins_config_pm(codina_r0_0_power_save_bank0,
