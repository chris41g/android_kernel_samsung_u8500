...
static int u8500_panic_regulator_enable(struct regulator_dev *rdev)
{
	struct u8500_regulator_info *info = rdev_get_drvdata(rdev);
...
static int u8500_panic_regulator_disable(struct regulator_dev *rdev)
{
	struct u8500_regulator_info *info = rdev_get_drvdata(rdev);
	int ret = 0;
...
static int u8500_panic_regulator_is_enabled(struct regulator_dev *rdev)
{
	struct u8500_regulator_info *info = rdev_get_drvdata(rdev);
 ...
 * Regulator switch
 */
static int u8500_panic_regulator_switch_enable(struct regulator_dev *rdev)
{
	struct u8500_regulator_info *info = rdev_get_drvdata(rdev);
	int ret;
...
static int u8500_panic_regulator_switch_disable(struct regulator_dev *rdev)
{
	struct u8500_regulator_info *info = rdev_get_drvdata(rdev);
	int ret = -EPERM;
...
static int u8500_panic_regulator_switch_is_enabled(struct regulator_dev *rdev)
{
	struct u8500_regulator_info *info = rdev_get_drvdata(rdev);
...
void u8500_reroute_regulator_fp(void)
{
	ux500_regulator_ops.enable = u8500_panic_regulator_enable;
	ux500_regulator_ops.disable = u8500_panic_regulator_disable;
	ux500_regulator_ops.is_enabled = u8500_panic_regulator_is_enabled;

	ux500_regulator_switch_ops.enable = u8500_panic_regulator_switch_enable;
	ux500_regulator_switch_ops.disable = u8500_panic_regulator_switch_disable;
	ux500_regulator_switch_ops.is_enabled = u8500_panic_regulator_switch_is_enabled;
