...
static char *regulator_names[] = {"v-mmio-camera" , "v-ana", "v-mmio-cam2"};
#else
...
/*godin+*/
	...
	extra->camera_pins[PRIMARY_CAMERA_STBY].gpio = XSHUTDOWN_PRIMARY_SENSOR;
	extra->camera_pins[PRIMARY_CAMERA_STBY].active_high = 1;
	extra->camera_pins[PRIMARY_CAMERA_STBY].udelay = 0;

	extra->camera_pins[PRIMARY_CAMERA_RESET].gpio = RESET_PRIMARY_SENSOR;
	extra->camera_pins[PRIMARY_CAMERA_RESET].active_high = 1;
	extra->camera_pins[PRIMARY_CAMERA_RESET].udelay = 0;

	extra->camera_pins[SECONDARY_CAMERA_STBY].gpio = XSHUTDOWN_SECONDARY_SENSOR;
	extra->camera_pins[SECONDARY_CAMERA_STBY].active_high = 1;
	extra->camera_pins[SECONDARY_CAMERA_STBY].udelay = 0;

	extra->camera_pins[SECONDARY_CAMERA_RESET].gpio = RESET_SECONDARY_SENSOR;
	extra->camera_pins[SECONDARY_CAMERA_RESET].active_high = 1;
	extra->camera_pins[SECONDARY_CAMERA_RESET].udelay = 0;

	extra->camera_pins[FLASH_EN].gpio = CAM_FLASH_EN;
	extra->camera_pins[FLASH_EN].active_high = 1;
	extra->camera_pins[FLASH_EN].udelay = 0;

	extra->camera_pins[FLASH_MODE].gpio = CAM_FLASH_MODE;
	extra->camera_pins[FLASH_MODE].active_high = 1;
	extra->camera_pins[FLASH_MODE].udelay = 0;


	for(  i = PRIMARY_CAMERA_STBY ; i < CAMERA_PINS_END ; i++){
	err = nmk_config_pin(gpio_host[i] |
	      (extra->camera_pins[i].active_high? PIN_OUTPUT_LOW:PIN_OUTPUT_HIGH), 0);
	}
