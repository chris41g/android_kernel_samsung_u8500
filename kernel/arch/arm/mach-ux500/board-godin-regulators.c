...
struct ab8500_regulator_reg_init
	 ...
	 * NOTE! PRCMU register
	 */
	INIT_REGULATOR_REGISTER(AB8500_VSMPS3SEL2,             0x26),
	/*
 ...
 * AB8500 regulators
 */
struct regulator_init_data godin_regulators[AB8500_NUM_REGULATORS] = {
...
struct regulator_init_data godin_u8500_vape_regulator = {
	.constraints = {
		.name = "u8500-vape",
...
struct regulator_init_data godin_u8500_varm_regulator = {
	.constraints = {
		.name = "u8500-varm",
		.valid_ops_mask = REGULATOR_CHANGE_STATUS,
	},
...
struct regulator_init_data godin_u8500_vmodem_regulator = {
	.constraints = {
		.name = "u8500-vmodem",
		.valid_ops_mask = REGULATOR_CHANGE_STATUS,
	},
...
struct regulator_init_data godin_u8500_vpll_regulator = {
	.constraints = {
		.name = "u8500-vpll",
		.valid_ops_mask = REGULATOR_CHANGE_STATUS,
	},
...
struct regulator_init_data godin_u8500_vsmps1_regulator = {
	.constraints = {
		.name = "u8500-vsmps1",
		.valid_ops_mask = REGULATOR_CHANGE_STATUS,
	},
...
struct regulator_init_data godin_u8500_vsmps2_regulator = {
	.constraints = {
		.name = "u8500-vsmps2",
		.valid_ops_mask = REGULATOR_CHANGE_STATUS,
...
struct regulator_init_data godin_u8500_vsmps3_regulator = {
	.constraints = {
		.name = "u8500-vsmps3",
		.valid_ops_mask = REGULATOR_CHANGE_STATUS,
	},
...
struct regulator_init_data godin_u8500_vrf1_regulator = {
	.constraints = {
		.name = "u8500-vrf1",
		.valid_ops_mask = REGULATOR_CHANGE_STATUS,
	},
...
struct regulator_init_data godin_u8500_svammdsp_regulator = {
...
struct regulator_init_data godin_u8500_svammdspret_regulator = {
	.constraints = {
...
struct regulator_init_data godin_u8500_svapipe_regulator = {
	/* dependency to u8500-vape is handled outside regulator framework */
	.constraints = {
		.name = "u8500-sva-pipe",
		.valid_ops_mask = REGULATOR_CHANGE_STATUS,
...
struct regulator_init_data godin_u8500_siammdsp_regulator = {
	/* dependency to u8500-vape is handled outside regulator framework */
	.constraints = {
...
struct regulator_init_data godin_u8500_siammdspret_regulator = {
	.constraints = {
...
struct regulator_init_data godin_u8500_siapipe_regulator = {
	/* dependency to u8500-vape is handled outside regulator framework */
	.constraints = {
		.name = "u8500-sia-pipe",
		.valid_ops_mask = REGULATOR_CHANGE_STATUS,
...
struct regulator_init_data godin_u8500_sga_regulator = {
...
struct regulator_init_data godin_u8500_b2r2_mcde_regulator = {
	.supply_regulator = "u8500-vape",
	.constraints = {
...
struct regulator_init_data godin_u8500_esram12_regulator = {
	.supply_regulator = "u8500-vape",
	.constraints = {
		.name = "u8500-esram12",
		.valid_ops_mask = REGULATOR_CHANGE_STATUS,
...
struct regulator_init_data godin_u8500_esram12ret_regulator = {
	.constraints = {
...
struct regulator_init_data godin_u8500_esram34_regulator = {
	.supply_regulator = "u8500-vape",
	.constraints = {
		.name = "u8500-esram34",
		.valid_ops_mask = REGULATOR_CHANGE_STATUS,
...
struct regulator_init_data godin_u8500_esram34ret_regulator = {
	.constraints = {
