...
struct ssg_dpi_display_platform_data godin_dpi_pri_display_info = {
	.platform_enabled	= false,
	.reset_high		= false,
	.reset_gpio 		= LCD_RESX_GTI9060_R0_1,
	.pwr_gpio		= LCD_PWR_EN_GTI9060_R0_1,
	.bl_en_gpio		= LCD_BL_CTRL_GTI9060_R0_1,

	.power_on_delay		= 120,
	.reset_delay 		= 10,
	.sleep_out_delay	= 150,	/* FRAME_PERIOD_MS * 7, */

	.display_off_delay	= 25,
	.sleep_in_delay		= 190, /* FRAME_PERIOD_MS * 4, */

	.video_mode.xres	= 480, 
	.video_mode.yres	= 800,
	.video_mode.hsw		= 10,	/* 2, */
	.video_mode.hbp		= 20,	/* 2, */
	.video_mode.hfp		= 100,	/* 10, */
	.video_mode.vsw		= 2,
	.video_mode.vbp		= 10,	/* 4 */
	.video_mode.vfp		= 8,
...
static struct mcde_display_device generic_display0 = {
	...
	.chnl_id = MCDE_CHNL_A,
	.fifo = MCDE_FIFO_A,
	.default_pixel_format = MCDE_OVLYPIXFMT_RGBA8888,//support RGBA888 for godin
	.native_x_res = 480,
	.native_y_res = 800,
	...
	.dev = {
		.platform_data = &godin_dpi_pri_display_info,
	},
...
int __init init_godin_display_devices(void)
{
	int ret;
	...
	if (display_initialized_during_boot) {
		...
		godin_dpi_pri_display_info.platform_enabled = 1;
	}

	if (system_rev <= GTI9060_R0_1)
		generic_display0.name = LCD_DRIVER_NAME_I9060;
	else
		generic_display0.name = LCD_DRIVER_NAME_S6E63M0;
	/*
	 * The pixclock setting is not used within MCDE. The clock is
	 * setup elsewhere. But the pixclock value is visible in user
	 * space.
	 */
	godin_dpi_pri_display_info.video_mode.pixclock /= port0.phy.dpi.clock_div;
...
module_init(init_godin_display_devices);
