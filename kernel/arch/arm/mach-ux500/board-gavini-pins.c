...
*/
static pin_cfg_t gavini_r0_0_pins[] = {
	/* GBF UART */
	...
	GPIO31_GPIO		| PIN_OUTPUT_HIGH,	/* lcd_bl */
	...
	GPIO203_GPIO		| PIN_INPUT_NOPULL,	/* Projector barrel control signal */
	GPIO204_GPIO		| PIN_INPUT_NOPULL,	/* Projector barrel control signal */
...
static pin_cfg_t gavini_r0_0_B_pins[] = {
	/* GBF UART */
	/* uart-0 pins gpio configuration should be
	 * kept intact to prevent glitch in tx line
	 * when tty dev is opened. Later these pins
...
static pin_cfg_t gavini_r0_0_C_pins[] = {
	/* GBF UART */
	/* uart-0 pins gpio configuration should be
	 * kept intact to prevent glitch in tx line
	 * when tty dev is opened. Later these pins
...
static pin_cfg_t gavini_r0_1_pins[] = {
	/* GBF UART */
	/* uart-0 pins gpio configuration should be
	 * kept intact to prevent glitch in tx line
	 * when tty dev is opened. Later these pins
...
static pin_cfg_t gavini_r0_0_c_modem_trace[] = {
	GPIO22_GPIO | PIN_INPUT_NOPULL, /* CLK-f */
	GPIO23_STMMOD_CLK | PIN_SLPM_USE_MUX_SETTINGS_IN_SLEEP,	/* STM CLK */
	GPIO24_UARTMOD_RXD | PIN_SLPM_USE_MUX_SETTINGS_IN_SLEEP, /* STM UART RXD */
	GPIO25_STMMOD_DAT0 | PIN_SLPM_USE_MUX_SETTINGS_IN_SLEEP, /* STM DAT0 */
	...
	GPIO193_GPIO		| PIN_OUTPUT_HIGH,	/* TXS0206-29_EN */
};

static pin_cfg_t gavini_r0_0_fidobox_trace[] = {
...
static pin_cfg_t gavini_r0_0_sdmmc[] = {
	/* MMC0 (MicroSD card) */
...
static UX500_PINS(gavini_r0_0_i2c2,
	GPIO8_I2C2_SDA,
	GPIO9_I2C2_SCL,
);

	/* TSU6111(micro-USB switch  */
static UX500_PINS(gavini_r0_0_i2c1,
	GPIO16_I2C1_SCL,
	GPIO17_I2C1_SDA,
);

	/* Proximity Sensor I2C */
static UX500_PINS(gavini_r0_0_i2c0,
	GPIO147_I2C0_SCL,
	GPIO148_I2C0_SDA,
);

	/* Touchscreen I2C */
static UX500_PINS(gavini_r0_0_i2c3,
	GPIO229_I2C3_SDA,
	GPIO230_I2C3_SCL,
);

static UX500_PINS(gavini_r0_0_mcde_dpi,
	/* DPI LCD RGB I/F */
	GPIO70_LCD_D0,
	GPIO71_LCD_D1,
	GPIO72_LCD_D2,
...
static pin_cfg_t gavini_gps_rev0_0_pins[] = {
	...
	PIN_CFG(GPS_ON_OFF_GAVINI_R0_0,GPIO)	| PIN_OUTPUT_LOW,	/* GPS_ON_OFF */
};

static pin_cfg_t gavini_gps_rev0_0_B_pins[] = {
	GPIO4_U1_RXD	| PIN_INPUT_PULLUP,	/* GPS UART */
	GPIO5_U1_TXD	| PIN_OUTPUT_HIGH,	/* GPS UART */
	PIN_CFG(GPS_RST_N_GAVINI_R0_0,GPIO)	| PIN_OUTPUT_HIGH,	/* GPS_RST_N */
...
static pin_cfg_t gavini_gps_rev0_0_C_pins[] = {
	GPIO4_U1_RXD | PIN_INPUT_PULLUP, /* GPS UART */
	GPIO5_U1_TXD | PIN_OUTPUT_HIGH, /* GPS UART */
	GPIO6_U1_CTSn | PIN_INPUT_PULLUP,
	GPIO7_U1_RTSn | PIN_OUTPUT_HIGH,

	PIN_CFG(GPS_RST_N_GAVINI_R0_0, GPIO) | PIN_OUTPUT_HIGH,
	PIN_CFG(GPS_ON_OFF_GAVINI_R0_0, GPIO) | PIN_OUTPUT_LOW,
};
...
static void __init sdmmc_pins_init(void)
{
	...
	if (sec_debug_settings & SEC_DBG_STM_APE_OPT) {
		...
		if (system_rev < GAVINI_R0_0_C) {
			nmk_config_pins(gavini_r0_0_modem_trace, ARRAY_SIZE(gavini_r0_0_modem_trace));
		} else {
			nmk_config_pins(gavini_r0_0_c_modem_trace, ARRAY_SIZE(gavini_r0_0_c_modem_trace));
		}
...
static pin_cfg_t gavini_r0_0_power_save_bank0[] = {
...
static pin_cfg_t gavini_common_sleep_table[] = {
	GPIO32_GPIO | PIN_INPUT_NOPULL,  /* PRJ_ON_HOT_KEY */
...
/*	GPIO141_GPIO | PIN_OUTPUT_LOW, */ /* CAM_FLASH_MODE */
	...
	GPIO151_GPIO | PIN_INPUT_PULLDOWN,
	GPIO152_GPIO | PIN_INPUT_PULLDOWN,
...
/*	GPIO193_GPIO | PIN_INPUT_PULLDOWN, */
	...
	GPIO194_GPIO | PIN_OUTPUT_LOW,  /* MOT_HEN */
	GPIO195_GPIO | PIN_OUTPUT_LOW,  /* MOT_LEN */
/*	GPIO196_GPIO | PIN_INPUT_NOPULL, */ /* MPR_SCL */
/*	GPIO197_GPIO | PIN_INPUT_NOPULL, */ /* MPR_SDA */
/*	GPIO198_GPIO | PIN_INPUT_NOPULL, */ /* PROJECTOR_INTZ */
...
/*	GPIO200_GPIO | PIN_INPUT_PULLDOWN, */
	...
	GPIO204_GPIO | PIN_OUTPUT_HIGH,  /* COMPASS_RST */
	GPIO205_GPIO | PIN_INPUT_NOPULL,  /* MODRV_IN3 */
	GPIO206_GPIO | PIN_INPUT_NOPULL,  /* MODRV_IN4 */
	GPIO207_GPIO | PIN_INPUT_NOPULL,  /* MODRV_IN1 */
...
/*	GPIO220_GPIO | PIN_OUTPUT_LOW, */ /* LCD_SCL */
	GPIO221_GPIO | PIN_INPUT_NOPULL,  /* MODRV_IN2 */
...
static pin_cfg_t gavini_r0_0_b_sleep_table[] = {
	GPIO192_GPIO | PIN_INPUT_PULLDOWN, /* NC */
	GPIO193_GPIO | PIN_INPUT_PULLDOWN, /* NC */
	GPIO200_GPIO | PIN_INPUT_PULLDOWN, /* NC */
	GPIO225_GPIO | PIN_INPUT_PULLDOWN, /* NC */
...
static pin_cfg_t gavini_r0_0_c_sleep_table[] = {
 ...
 * controlling their pin settings when in inactive mode.
 */
static void gavini_pins_suspend_force_mux(void)
{
	u32 bankaddr;
