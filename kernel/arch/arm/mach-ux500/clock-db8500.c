...
static struct clk_lookup u8500_v2_prcmu_clocks[] = {
	...
	CLK_LOOKUP(clkout1, "mot-pwm1", NULL),		/* input clk for Vibrator */
};
...
static int __init init_clock_states(void)
{
	...
	/* LCD HW SPECIFIC: LCDCLK could be used for the DPI LCD splash screen so
	   it is important to not switch it off in this case. */
