...
#define MXT224E_THRESHOLD_CHRG		45
...
static u8 t48_config_e[] = {PROCG_NOISESUPPRESSION_T48,
				...
				6,	6, 0, 0, 48, 4, 48, 10, 0, 10, 5, 0, 20, 0, 5,
...
static u8 t48_config_chrg_e[] = {PROCG_NOISESUPPRESSION_T48,
				...
				6,	6, 0, 0, 64, 4, 64, 10,
				0, 10, 5, 0, 15, 0, 20,
				0, 0, 0, 0, 0, 0, 16, MXT224E_THRESHOLD_CHRG, 2, 5, 2, 47, MXT224_MAX_MT_FINGERS, 5, 40, 235, 235,
...
/**
 * janice_gpio_wq_kdebounce - work queue to debounce GPIO inputs.
...
void janice_gpio_wq_debounce(struct work_struct *work)
{
	int cnt;
	int input_state;
...
static struct stm_msp_controller janice_msp2_spi_data = {
	.id		= MSP_2_CONTROLLER,
...
static struct regulator_init_data *u8500_regulators[U8500_NUM_REGULATORS] = {
	[U8500_REGULATOR_VAPE]			= &janice_u8500_vape_regulator,
	[U8500_REGULATOR_VARM]			= &janice_u8500_varm_regulator,
	[U8500_REGULATOR_VMODEM]		= &janice_u8500_vmodem_regulator,
	[U8500_REGULATOR_VPLL]			= &janice_u8500_vpll_regulator,
	[U8500_REGULATOR_VSMPS1]		= &janice_u8500_vsmps1_regulator,
	[U8500_REGULATOR_VSMPS2]		= &janice_u8500_vsmps2_regulator,
	[U8500_REGULATOR_VSMPS3]		= &janice_u8500_vsmps3_regulator,
	[U8500_REGULATOR_VRF1]			= &janice_u8500_vrf1_regulator,
	[U8500_REGULATOR_SWITCH_SVAMMDSP]	= &janice_u8500_svammdsp_regulator,
	[U8500_REGULATOR_SWITCH_SVAMMDSPRET]	= &janice_u8500_svammdspret_regulator,
	[U8500_REGULATOR_SWITCH_SVAPIPE]	= &janice_u8500_svapipe_regulator,
	[U8500_REGULATOR_SWITCH_SIAMMDSP]	= &janice_u8500_siammdsp_regulator,
	[U8500_REGULATOR_SWITCH_SIAMMDSPRET]	= &janice_u8500_siammdspret_regulator,
	[U8500_REGULATOR_SWITCH_SIAPIPE]	= &janice_u8500_siapipe_regulator,
	[U8500_REGULATOR_SWITCH_SGA]		= &janice_u8500_sga_regulator,
	[U8500_REGULATOR_SWITCH_B2R2_MCDE]	= &janice_u8500_b2r2_mcde_regulator,
	[U8500_REGULATOR_SWITCH_ESRAM12]	= &janice_u8500_esram12_regulator,
	[U8500_REGULATOR_SWITCH_ESRAM12RET]	= &janice_u8500_esram12ret_regulator,
	[U8500_REGULATOR_SWITCH_ESRAM34]	= &janice_u8500_esram34_regulator,
	[U8500_REGULATOR_SWITCH_ESRAM34RET]	= &janice_u8500_esram34ret_regulator,
};
...
static struct ab8500_platform_data ab8500_platdata = {
	...
	.pm_power_off = true,
	.regulator_reg_init	= janice_ab8500_regulator_reg_init,
	.num_regulator_reg_init	= ARRAY_SIZE(janice_ab8500_regulator_reg_init),
...
static struct platform_device *janice_platform_devices[] __initdata = {
...
//godin -
	...
	platform_add_devices(janice_platform_devices,
			     ARRAY_SIZE(janice_platform_devices));
