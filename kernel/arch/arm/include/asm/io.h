...
#define writeb(v,c)		({ __iowmb(); __write_log(c); writeb_relaxed(v,c); })
#define writew(v,c)		({ __iowmb(); __write_log(c); writew_relaxed(v,c); })
#define writel(v,c)		({ __iowmb(); __write_log(c); writel_relaxed(v,c); })
